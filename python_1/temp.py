...
while user_wants_workout:
    # print("Welcome to FitPlan!", end="\n\n") # End with 2 new lines
    print("Welcome to FitPlan!\n")
    ...
    while fitness_level not in [1, 2, 3]:
        fitness_level = int(
            input("Silly, please enter 1, 2 or 3. Don't mess up this time!!!!!!: ")
        )
    ...
    if fitness_goal == 1:
        ...
        if roundcut_precentage < 21:
            print(
                "Congratulations! You have been recommended the 'Easy Breezy Body Trim' cut course.\n\nThis is a low intensity workout plan.\n\n It's so easy your pet hamster could do it!"
            )
            print(
            ...
            print(
                "Congratulations! You have been recommended the 'Spicey Shred Squad' cut course.\n\nThis is a medium intensity workout plan where spicey meets sweatiness!"
            )
            print(
        ...
        current_endurance_minutes = int(
            input("\nHow many minutes do you currently train for?:  ")
        )
        goal_endurance_minutes = int(
            input(
        ...
        precentage_endurance_goal = (
            goal_endurance_minutes
